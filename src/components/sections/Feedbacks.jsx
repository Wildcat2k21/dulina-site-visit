      ...
      <div className="reviews__list">
        <div className="reviews__item">
          ...
          <p className="review__feedback">
            Обратилась в сложный период, когда казалось, что всё рушится. Евгения не росто дала
            ответы на мои вопросы — она помогла увидеть ...
          </p>
        </div>
        ...
        <div className="reviews__item">
          ...
          <img className="reviews__stars-mac" src="./images/stars.png" />
          <p className="review__feedback">
            Очень понравилась консультация! Получила ответы на все вопросы! Обязательно приду еще!
            🙏 ❤️
          </p>
        </div>
      </div>
